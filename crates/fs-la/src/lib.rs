...
pub use gemm::{
    ...
    GEMM_PANEL_RUN_DOMAIN, GemmCancelled, GemmMemoryEnvelope, GemmMemoryReport, GemmRunError,
    ...
    gemm_f64_parallel_with_pool_declared, gemm_mixed, gemm_panel_run_id, gemm_tuning_is_effective,
};
