...
pub const SESSION_OPEN_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-session/src/token.rs#SessionId",
...
pub const SESSION_TOKEN_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-session/src/token.rs#CapabilityToken",
...
pub const GATE_BINDING_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-session/src/governor.rs#GateBindingIdentitySource",
...
pub const SUBMISSION_AGENT_KEY_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-session/src/lib.rs#SessionError",
    "schema_dependencies=none",
    "digest=fs-blake3",
    "encoding=typed-binary",
...
pub const SUBMISSION_RECEIPT_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-session/src/governor.rs#SubmissionCompletion",
