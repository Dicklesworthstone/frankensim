...
pub const GATE_BINDING_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-session/src/governor.rs#GateBindingIdentitySource,crates/fs-session/src/guidance.rs#Guidance,crates/fs-session/src/lib.rs#SessionError,crates/fs-session/src/token.rs#CapabilityToken,crates/fs-session/src/token.rs#SessionId",
