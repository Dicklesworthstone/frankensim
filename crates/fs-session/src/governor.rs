...
pub const DURABLE_GOVERNOR_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-session/src/guidance.rs#Guidance,crates/fs-session/src/lib.rs#SessionError,crates/fs-session/src/token.rs#CapabilityToken,crates/fs-session/src/token.rs#SessionId",
...
pub const SESSION_OPEN_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-session/src/guidance.rs#Guidance,crates/fs-session/src/lib.rs#SessionError,crates/fs-session/src/token.rs#CapabilityToken,crates/fs-session/src/token.rs#SessionId,std#Vec",
...
pub const GATE_BINDING_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-session/src/governor.rs#GateBindingIdentitySource,crates/fs-session/src/guidance.rs#Guidance,crates/fs-session/src/lib.rs#SessionError,crates/fs-session/src/token.rs#CapabilityToken,crates/fs-session/src/token.rs#SessionId,std#Vec",
...
pub const PAUSE_ACKNOWLEDGEMENT_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-session/src/guidance.rs#Guidance,crates/fs-session/src/lib.rs#SessionError,crates/fs-session/src/token.rs#CapabilityToken,crates/fs-session/src/token.rs#SessionId,std#Arc",
...
pub const SUBMISSION_RECEIPT_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-session/src/governor.rs#SubmissionCompletion,crates/fs-session/src/guidance.rs#Guidance,crates/fs-session/src/lib.rs#SessionError,crates/fs-session/src/token.rs#CapabilityToken,crates/fs-session/src/token.rs#SessionId",
