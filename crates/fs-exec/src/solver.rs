...
pub mod snapshot_v2 {
    ...
    pub const SNAPSHOT_RESUME_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
        ...
        "encoder_helpers=snapshot_v2::resume_identity_components,snapshot_v2::encode_resume_receipt,snapshot_v2::ExpectedResumeContextV2::for_paused_state,snapshot_v2::SnapshotResumeContextV2::for_paused_state,snapshot_v2::SnapshotResumeContextV2::from_header,snapshot_v2::PausedSnapshotBoundaryV2::from_drain_report,snapshot_v2::PausedSnapshotBoundaryV2::declaration,snapshot_v2::DeclaredPausedSnapshotBoundaryV2::from_header,snapshot_v2::current_drain_report_era",
