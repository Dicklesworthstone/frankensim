...
pub const TILEPOOL_PLACEMENT_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-exec/src/cx.rs#CancelGate,crates/fs-exec/src/cx.rs#RefusalSink,crates/fs-exec/src/cx.rs#RunId,crates/fs-exec/src/cx.rs#TileFailure,std#Vec",
