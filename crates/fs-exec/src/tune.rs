...
pub const GEMM_TUNE_KEY_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-exec/src/cx.rs#CancelGate,crates/fs-exec/src/kernel.rs#TilePlan,crates/fs-exec/src/pool.rs#PoolConfig,crates/fs-exec/src/pool.rs#TilePool",
...
pub const TUNE_ROW_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-exec/src/cx.rs#CancelGate,crates/fs-exec/src/kernel.rs#TilePlan,crates/fs-exec/src/pool.rs#PoolConfig,crates/fs-exec/src/pool.rs#TilePool,std#String",
