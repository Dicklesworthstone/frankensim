...
pub const IDENTITY_MIGRATION_RECEIPT_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-blake3/src/identity.rs#StrongIdentity,crates/fs-blake3/src/lib.rs#ContentHash,crates/fs-ledger/src/lib.rs#EdgeRole,crates/fs-ledger/src/lib.rs#Ledger,crates/fs-ledger/src/lib.rs#LedgerError,crates/fs-ledger/src/lib.rs#LedgerInstanceId,crates/fs-ledger/src/lib.rs#PrehashedOpContent",
