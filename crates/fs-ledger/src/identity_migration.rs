...
pub const IDENTITY_MIGRATION_RECEIPT_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "excluded_fields=exact-legacy-bytes:bound-by-content-id-and-byte-count,exact-canonical-bytes:bound-by-content-id-and-byte-count,created-at:provenance-envelope-only",
