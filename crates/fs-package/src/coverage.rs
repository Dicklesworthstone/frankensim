...
pub const PRESENCE_DECISION_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-package/src/lib.rs#AdmissionClass,crates/fs-package/src/lib.rs#EvidencePackage,crates/fs-package/src/lib.rs#PackageReport,crates/fs-package/src/lib.rs#SignatureStatus,crates/fs-package/src/lib.rs#VerificationReceipt,crates/fs-package/src/lib.rs#VerifiedPackage,crates/fs-package/src/origin.rs#SignaturePurpose,crates/fs-package/src/origin.rs#VerificationCapabilities",
...
pub const COVERAGE_DECISION_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-crosswalk/src/lib.rs#PackageConcept,crates/fs-package/src/lib.rs#AdmissionClass,crates/fs-package/src/lib.rs#EvidencePackage,crates/fs-package/src/lib.rs#PackageReport,crates/fs-package/src/lib.rs#SignatureStatus,crates/fs-package/src/lib.rs#VerificationReceipt,crates/fs-package/src/lib.rs#VerifiedPackage,crates/fs-package/src/origin.rs#SignaturePurpose,crates/fs-package/src/origin.rs#VerificationCapabilities",
    "schema_dependencies=fs-package:verification-receipt",
    "digest=blake3-derive-key",
    "encoding=typed-binary",
