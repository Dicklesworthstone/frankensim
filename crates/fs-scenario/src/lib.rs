...
pub use acoustic::{
    ...
    HelmholtzCavity, Listener, Pluck, PrestressedString, RadiatingPlate, RayleighParams, ThinPlate,
    ToneHole, UnilateralObstacle, ViscothermalDuct, VolumeVelocityPulse, WaveguideEnd,
};
