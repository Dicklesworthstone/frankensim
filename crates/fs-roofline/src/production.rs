...
pub const DEPENDENCY_AUTHORITY_POLICY_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-roofline/src/axes.rs#MachineAxes,crates/fs-roofline/src/lib.rs#Attainment,crates/fs-roofline/src/lib.rs#AttestedAxisBaselinePolicy,crates/fs-roofline/src/lib.rs#AxisAdmissionSnapshot,crates/fs-roofline/src/lib.rs#AxisBaselinePolicy,crates/fs-roofline/src/lib.rs#DependencyReceiptBinding,crates/fs-roofline/src/lib.rs#FinalizedRegistryRun",
