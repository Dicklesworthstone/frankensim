...
pub const STALENESS_ROW_CONTENT_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-roofline/src/lib.rs#BuildRowScan,crates/fs-roofline/src/lib.rs#DependencyReceiptBinding,crates/fs-roofline/src/lib.rs#RowSelection,crates/fs-roofline/src/lib.rs#Staleness,crates/fs-roofline/src/lib.rs#ValidatedRooflineRow",
