...
pub const CLAIM_EVIDENCE_PACKET_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-euler-disc-e2e/src/contract.rs#ContractError,crates/fs-euler-disc-e2e/src/contract.rs#ContractIdentity,crates/fs-euler-disc-e2e/src/contract.rs#EulerClaimGraph,crates/fs-euler-disc-e2e/src/contract.rs#EulerClaimKind,crates/fs-euler-disc-e2e/src/contract.rs#EulerClaimSpec,crates/fs-euler-disc-e2e/src/contract.rs#EulerContextExtension,crates/fs-euler-disc-e2e/src/contract.rs#EulerScientificContract,crates/fs-euler-disc-e2e/src/contract.rs#EvidenceRequirement,crates/fs-euler-disc-e2e/src/contract.rs#HypothesisSource,crates/fs-euler-disc-e2e/src/contract.rs#OwnerMatrix,crates/fs-euler-disc-e2e/src/contract.rs#OwnerRole,crates/fs-euler-disc-e2e/src/contract.rs#OwnerRow,crates/fs-euler-disc-e2e/src/contract.rs#ScientificRisk",
