...
pub const CANONICAL_PARAMETER_BLOCK_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-blake3/src/lib.rs#ContentHash,crates/fs-matdb/src/lib.rs#ClaimSet,crates/fs-matdb/src/lib.rs#MatDbError,crates/fs-matdb/src/lib.rs#PropertyClaim",
