...
pub const DWR_OUTPUT_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-exec/src/cx.rs#Cx,crates/fs-verify/src/fem1d.rs#MmsProblem",
...
pub const DWR_ACCEPT_IDENTITY_SCHEMA_DECLARATION: &[&str] = &[
    ...
    "schema_types=crates/fs-evidence/src/color.rs#Color,crates/fs-exec/src/cx.rs#Cx,crates/fs-verify/src/fem1d.rs#MmsProblem",
