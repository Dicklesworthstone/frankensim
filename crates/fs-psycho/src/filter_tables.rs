//! ISO 532-1 third-octave filterbank coefficient tables for a
//! 48 kHz sampling rate, transcribed MECHANICALLY by script
//! (gen_filter_tables.py) from the standard's reference C source
//! (Annex A.4 electronic insert, ISO_532-1.c) — never by hand, never
//! from memory. The working biquad coefficients are
//! `REF - DIFF` per stage, exactly as the reference computes them.

/// Reference biquad table (3 stages x [b0,b1,b2,a0,a1,a2]).
...
/// Per-band difference-from-reference tables (28 bands x 3 stages
/// x 6 coefficients), 48 kHz.
pub const FILTER_DIFF: [[[f64; 6]; 3]; 28] = [
    [
...
/// Per-band, per-stage input gains (28 bands x 3 stages).
pub const FILTER_GAIN: [[f64; 3]; 28] = [
    [4.30764e-11, 1.0, 1.0],
    [8.5934e-11, 1.0, 1.0],
    [1.71424e-10, 1.0, 1.0],
    [3.41944e-10, 1.0, 1.0],
