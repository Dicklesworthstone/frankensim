...
[![Crates](https://img.shields.io/badge/workspace-147%20native%20fs--%2A%20crates-0969da)](#implemented-workspace)
[![Contracts](https://img.shields.io/badge/contracts-148%20of%20148%20crates-8250df)](#contracts-and-verification)
[![Tests](https://img.shields.io/badge/tests-657%20tracked%20integration%20test%20files-1f883d)](#contracts-and-verification)
...
|-------------------------|-------|
| Native workspace `fs-*` crates | 147 |
| Standalone `fs-*` workspaces | 1 (`fs-wasm`) |
| Tracked `fs-*` crate directories | 148 |
| Tracked `CONTRACT.md` files | 148 of 148 |
| Tracked crate integration-test files | 657 |
| `fs-*` layer inventory | `UTIL=15`, `L0=7`, `L1=14`, `L2=18`, `L3=31`, `L4=32`, `L5=4`, `L6=26`, `TOOL=1` |
...
|------|------------------------|
| Workspace | Rust 2024 nightly Cargo workspace with 147 native `fs-*` workspace crates plus `xtask`; `fs-wasm` is a standalone nested workspace |
| Contracts | 148 of 148 `fs-*` crate directories have `CONTRACT.md` files |
...
| Tests | 657 Rust files under crate `tests/` directories in the checked inventory, in addition to inline unit tests; this is an inventory count, not a claim that every test is green on the current tree |
...
The tree currently has 148 `CONTRACT.md` files for 148 `fs-*` crate directories.
...
|-- crates/                            # 148 fs-* crates; selected entries shown below
