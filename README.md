...
[![Crates](https://img.shields.io/badge/workspace-153%20native%20fs--%2A%20crates-0969da)](#implemented-workspace)
[![Contracts](https://img.shields.io/badge/contracts-154%20of%20154%20crates-8250df)](#contracts-and-verification)
[![Tests](https://img.shields.io/badge/tests-667%20tracked%20integration%20test%20files-1f883d)](#contracts-and-verification)
...
|-------------------------|-------|
| Native workspace `fs-*` crates | 153 |
| Standalone `fs-*` workspaces | 1 (`fs-wasm`) |
| Tracked `fs-*` crate directories | 154 |
| Tracked `CONTRACT.md` files | 154 of 154 |
| Tracked crate integration-test files | 667 |
| `fs-*` layer inventory | `UTIL=15`, `L0=7`, `L1=14`, `L2=19`, `L3=35`, `L4=32`, `L5=4`, `L6=27`, `TOOL=1` |
...
|------|------------------------|
| Workspace | Rust 2024 nightly Cargo workspace with 153 native `fs-*` workspace crates plus `xtask`; `fs-wasm` is a standalone nested workspace |
| Contracts | 154 of 154 `fs-*` crate directories have `CONTRACT.md` files |
...
The tree currently has 154 `CONTRACT.md` files for 154 `fs-*` crate directories.
...
|-- crates/                            # 154 fs-* crates; selected entries shown below
