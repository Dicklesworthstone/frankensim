...
[![Crates](https://img.shields.io/badge/workspace-154%20native%20fs--%2A%20crates-0969da)](#implemented-workspace)
[![Contracts](https://img.shields.io/badge/contracts-155%20of%20155%20crates-8250df)](#contracts-and-verification)
[![Tests](https://img.shields.io/badge/tests-668%20tracked%20integration%20test%20files-1f883d)](#contracts-and-verification)
...
|-------------------------|-------|
| Native workspace `fs-*` crates | 154 |
| Standalone `fs-*` workspaces | 1 (`fs-wasm`) |
| Tracked `fs-*` crate directories | 155 |
| Tracked `CONTRACT.md` files | 155 of 155 |
| Tracked crate integration-test files | 668 |
| `fs-*` layer inventory | `UTIL=15`, `L0=7`, `L1=14`, `L2=19`, `L3=36`, `L4=32`, `L5=4`, `L6=27`, `TOOL=1` |
...
|------|------------------------|
| Workspace | Rust 2024 nightly Cargo workspace with 154 native `fs-*` workspace crates plus `xtask`; `fs-wasm` is a standalone nested workspace |
| Contracts | 155 of 155 `fs-*` crate directories have `CONTRACT.md` files |
...
The tree currently has 155 `CONTRACT.md` files for 155 `fs-*` crate directories.
...
|-- crates/                            # 155 fs-* crates; selected entries shown below
