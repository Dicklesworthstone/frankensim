...
[![Crates](https://img.shields.io/badge/workspace-152%20native%20fs--%2A%20crates-0969da)](#implemented-workspace)
[![Contracts](https://img.shields.io/badge/contracts-153%20of%20153%20crates-8250df)](#contracts-and-verification)
[![Tests](https://img.shields.io/badge/tests-666%20tracked%20integration%20test%20files-1f883d)](#contracts-and-verification)
...
|-------------------------|-------|
| Native workspace `fs-*` crates | 152 |
| Standalone `fs-*` workspaces | 1 (`fs-wasm`) |
| Tracked `fs-*` crate directories | 153 |
| Tracked `CONTRACT.md` files | 153 of 153 |
| Tracked crate integration-test files | 666 |
| `fs-*` layer inventory | `UTIL=15`, `L0=7`, `L1=14`, `L2=19`, `L3=34`, `L4=32`, `L5=4`, `L6=27`, `TOOL=1` |
...
|------|------------------------|
| Workspace | Rust 2024 nightly Cargo workspace with 152 native `fs-*` workspace crates plus `xtask`; `fs-wasm` is a standalone nested workspace |
| Contracts | 153 of 153 `fs-*` crate directories have `CONTRACT.md` files |
...
The tree currently has 153 `CONTRACT.md` files for 153 `fs-*` crate directories.
...
|-- crates/                            # 153 fs-* crates; selected entries shown below
