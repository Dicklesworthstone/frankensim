...
enum SimulationCatalog {
    static let all: [SimulationExperiment] = [
        ...
        item(15, "Incompressible smoke", "Pressure makes motion honest", "Buoyant smoke is advected semi-Lagrangianly, then projected through a sparse Poisson solve.", .frontier, "smoke", .violet, .estimated, "Stable-fluids imagery is not a validated CFD result.", "fs-sparse"),
